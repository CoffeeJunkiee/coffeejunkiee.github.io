...
To be honest this box was rough because I took some time to do it by myself and try to solve a couple rabbit holes such as the word-list and the password cracking, but I have to say that I gain some knowledge related to brute force attacks. Also the escalation privileges was straight forward having a guide in the hand. 
